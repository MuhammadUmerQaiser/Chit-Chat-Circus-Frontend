...
export default function VerifyCode({ continueFormProcess }) {
            ...
            <form className="space-y-2 md:space-y-6" action="#">
                <div>
                    ...
                    {formik.errors.code && formik.touched.code && (
                        <span className="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">{formik.errors.code}</span>
                    )}
                </div>
                {!isLoading ? (
                    <button
